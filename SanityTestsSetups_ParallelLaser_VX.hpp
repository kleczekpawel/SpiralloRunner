...
void setup_SanityTest__2026_01_14_Spirallo_Laser_VX_18_1__crawler20p_camera50p(
    ...
    WinCan::Spirallo::Path& videoPath,
    WinCan::Spirallo::Path& vifPath,
    ...
    WinCan::Spirallo::Path& imageProcessingConfigPath,
    WinCan::Spirallo::Path& cameraConfigPath,
    WinCan::Spirallo::Path& framesOutputDir,
    std::optional<double>& calibrationSlope,
    std::optional<double>& calibrationIntercept,
    WinCan::Spirallo::Path& robotCsvFile,
    WinCan::Spirallo::Path& distancesCsvFilepath,
    WinCan::Spirallo::Path& videoParametersFilepath)
{
    recordingIdStr =
        R"(crawler 20% camera 50 %_8573a323-9df6-448a-9da2-7661e6a5650b7cddaa9e-4b3f-4e4d-8dc9-f7acbbf48cec)";

    WinCan::Spirallo::Path rootDir{
    ...
    calibrationIntercept = 0.0149599574506283;
    UNUSED(robotCsvFile);
    ...
    WinCan::Spirallo::Path& videoParametersFilepath)
{
    ...
    UNUSED(framesOutputDir);
    UNUSED(calibrationSlope);
    calibrationSlope = 2017.13991165161;
    UNUSED(calibrationIntercept);
    calibrationIntercept = 0.0127100003883243;
    UNUSED(robotCsvFile);
    UNUSED(distancesCsvFilepath);
    UNUSED(videoParametersFilepath);
}
    ...
    WinCan::Spirallo::Path& videoParametersFilepath)
{
    ...
    UNUSED(framesOutputDir);
    UNUSED(calibrationSlope);
    calibrationSlope = 1714.92004394531;
    UNUSED(calibrationIntercept);
    calibrationIntercept = 0.0173000004142523;
    UNUSED(robotCsvFile);
    UNUSED(distancesCsvFilepath);
    UNUSED(videoParametersFilepath);
}
    ...
    WinCan::Spirallo::Path& videoParametersFilepath)
{
    ...
    UNUSED(framesOutputDir);
    UNUSED(calibrationSlope);
    calibrationSlope = 1734.09712314606;
    UNUSED(calibrationIntercept);
    calibrationIntercept = 0.0114374691620469;
    UNUSED(robotCsvFile);
    UNUSED(distancesCsvFilepath);
    UNUSED(videoParametersFilepath);
}
