...
void setup_hang_on_exec_finished(
    ...
    Path& imageProcessingConfigPath,
    Path& cameraConfigPath,
    Path& framesOutputDir,
    std::optional<double>& calibrationSlope,
    std::optional<double>& calibrationIntercept,
    Path& robotCsvFile,
    Path& distancesCsvFilepath,
    Path& videoParametersFilepath)
{
    ...
    Path rootDir{R"(D:\Projects\Spirallo\Videos\EXTRAS\spirallo_no_output)"};
                     ...
                     Path& videoParametersFilepath)
{
    ...
    Path rootDir{"D:/Projects/Spirallo/Videos/Keith/P002_05-02-2025 Wellen Park "
    ...
    Path& videoParametersFilepath)
{
    ...
    Path rootDir{"D:/Projects/Spirallo/Videos/Marcin/Video_with_defect/Video/Sec/"};
    // std::string
    ...
    robotCsvFile = Path{"spirallo_output_20250522_173852_robot_1.csv"};
                   ...
                   Path& videoParametersFilepath)
{
    ...
    Path rootDir{"D:/Projects/Spirallo/Videos/EXTRAS/Spirallo_with_defects_1/Video/Sec"};
                     ...
                     Path& videoParametersFilepath)
{
    ...
    Path rootDir{"D:/Projects/Spirallo/Videos/EXTRAS/WVX-10902/"
    ...
    Path& videoParametersFilepath)
{
    ...
    Path rootDir{"D:/Projects/Spirallo/Videos/EXTRAS/Albert_2025_07_15/Video/Sec"};
    ...
    Path& videoParametersFilepath)
{
    ...
    Path rootDir{R"(D:\Projects\Spirallo\Videos\EXTRAS\RCX100HD-RCX90X\RCX90X-DN150)"};
    ...
    Path& videoParametersFilepath)
{
    ...
    Path rootDir{R"(D:\Projects\Spirallo\Videos\EXTRAS\RCX100HD-RCX90X\RCX90X-DN200)"};
                  ...
                  Path& videoParametersFilepath)
{
    ...
    distancesCsvFilepath =
        Path{R"(D:\Development\Spirallo\_Spirallo_OUT\ToFix\)"} / "baudrate115200_dist_px.csv";
    UNUSED(videoParametersFilepath);
    videoParametersFilepath = Path{R"(D:\Development\Spirallo\_Spirallo_OUT\ToFix\)"}
    ...
    Path& videoParametersFilepath)
{
    ...
    UNUSED(robotCsvFile);
    robotCsvFile =
        Path{R"(D:\Development\Spirallo\_Spirallo_OUT\)"} / "speed_20250923_RCX100_70%100%.csv";
    UNUSED(distancesCsvFilepath);
    UNUSED(videoParametersFilepath);
}
    ...
    Path& videoParametersFilepath)
{
    ...
    UNUSED(calibrationIntercept);
    UNUSED(robotCsvFile);
    robotCsvFile = Path{R"(D:\Development\Spirallo\_Spirallo_OUT\Archive\)"}
    ...
    Path& videoParametersFilepath)
{
    ...
    UNUSED(calibrationIntercept);
    UNUSED(robotCsvFile);
    robotCsvFile = Path{R"(D:\Development\Spirallo\_Spirallo_OUT\ToFix\)"}
    ...
    Path& videoParametersFilepath)
{
    ...
    Path rootDir{R"(C:\WinCan_Projects\2025_12_22_spir_AM_RCX100_modified\Video\Sec)"};
    std::string recordingStem{"joy_speed_100_crawler_100_3c8caf65-5aae-4173-9e3a-"
                              "f25ab679299fecf61597-ce6d-4a6c-b212-0d7f5ccf6bda"};
    videoPath = rootDir / (recordingStem + ".mp4");
    vifPath = rootDir / (recordingStem + ".txt");
    ...
    Path& videoParametersFilepath)
{
    ...
    Path rootDir{R"(D:\Projects\Spirallo\Videos\iPEK\Spiralo 1040045201HA90\Video\Sec)"};
    ...
    Path& videoParametersFilepath)
{
    ...
    UNUSED(calibrationIntercept);
    // UNUSED(robotCsvFile);
    robotCsvFile = Path{R"(D:\Development\Spirallo\_Spirallo_OUT\ToFix\)"} / "ThorstenS3_robot.csv";
    UNUSED(distancesCsvFilepath);
    UNUSED(videoParametersFilepath);
}
    ...
    Path& videoParametersFilepath)
{
    ...
    // UNUSED(robotCsvFile);
    robotCsvFile =
        Path{R"(D:\Development\Spirallo\_Spirallo_OUT\ToFix\)"} / "2026-01-14_craw-20_cam-100.csv";
    UNUSED(distancesCsvFilepath);
    UNUSED(videoParametersFilepath);
}
    ...
    Path& videoParametersFilepath)
{
    ...
    UNUSED(calibrationIntercept);
    UNUSED(robotCsvFile);
    robotCsvFile = Path{R"(D:\Development\Spirallo\_Spirallo_OUT\ToFix\)"} / "AU_VIF_robot.csv";
    UNUSED(distancesCsvFilepath);
    distancesCsvFilepath =
        Path{R"(D:\Development\Spirallo\_Spirallo_OUT\ToFix\)"} / "AU_VIF_px.csv";
    UNUSED(videoParametersFilepath);
    videoParametersFilepath =
        Path{R"(D:\Development\Spirallo\_Spirallo_OUT\ToFix\)"} / "AU_VIF.json";
}
    ...
    Path& videoParametersFilepath)
{
    ...
    UNUSED(distancesCsvFilepath);
    distancesCsvFilepath = Path{R"(D:\Development\Spirallo\_Spirallo_OUT\ToFix\)"}
    ...
    Path& videoParametersFilepath)
{
    ...
    Path rootDir{R"(D:\Projects\Spirallo\Videos\EXTRAS\Albert_Calibration)"};
    std::string recordingStem{
                       ...
                       Path& videoParametersFilepath)
{
    ...
    Path rootDir{R"(D:\Projects\Spirallo\Videos\EXTRAS\Jacsonville - Copy\Video\Sec)"};
    std::string recordingStem{
                      ...
                      Path& videoParametersFilepath)
{
    ...
    UNUSED(robotCsvFile);
    UNUSED(distancesCsvFilepath);
    distancesCsvFilepath = Path{R"(D:\Development\Spirallo\_ISSUES\SPR-23_2pl_discrepancy)"}
                         / "SPR-23_Sec1_dist_px_ORG.csv";
    UNUSED(videoParametersFilepath);
    videoParametersFilepath = Path{R"(D:\Development\Spirallo\_ISSUES\SPR-23_2pl_discrepancy)"}
                            / "SPR-23_Sec1_video_params.json";
}

void setup_SPR30_76902b772b0b(
    std::string& recordingIdStr,
    Path& videoPath,
    Path& vifPath,
    std::string& cameraName,
    ...
    Path& videoParametersFilepath)
{
    recordingIdStr = "SPR-30_76902b772b0b";

    Path rootDir{R"(D:\Projects\Spirallo\Videos\Marcin\3-D_Demo-Projekt16.01.2026\Video\Sec)"};
    std::string recordingStem{
        R"(1010048001_bff118b9-d477-4401-a82f-34f8619bbe3c67a2ba19-14f8-4149-9796-76902b772b0b)"};
    videoPath = rootDir / (recordingStem + ".mp4");
    vifPath = rootDir / (recordingStem + ".txt");
    projectDistanceUnit = DistanceUnit::Meter;
    cameraName = "Ipek RCX100 HD Serie V";
    ...
    UNUSED(framesOutputDir);
    UNUSED(calibrationSlope);
    calibrationSlope = 1754.08124923706;
    UNUSED(calibrationIntercept);
    calibrationIntercept = 0.0123799284920096;
    UNUSED(robotCsvFile);
    UNUSED(distancesCsvFilepath);
    UNUSED(videoParametersFilepath);
}

void setup_SPR29_3bf7dcba41ff(
    std::string& recordingIdStr,
    Path& videoPath,
    Path& vifPath,
    std::string& cameraName,
    ...
    Path& videoParametersFilepath)
{
    recordingIdStr = "SPR-29_3bf7dcba41ff";

    Path rootDir{R"(D:\Projects\Spirallo\Videos\Marcin\20-03-26-Spirallo-RCX100\Video\Sec)"};
    std::string recordingStem{R"(50-50_ba3d15f9-0db0-47c4-a2d8-3bf7dcba41ff)"};
    videoPath = rootDir / (recordingStem + ".mp4");
    vifPath = rootDir / (recordingStem + ".txt");
    projectDistanceUnit = DistanceUnit::Meter;
    cameraName = "Ipek RCX100 HD Serie V";
    ...
    UNUSED(framesOutputDir);
    UNUSED(calibrationSlope);
    calibrationSlope = 1745.3733682632446;
    UNUSED(calibrationIntercept);
    calibrationIntercept = 0.010983848944306374;
    UNUSED(robotCsvFile);
    UNUSED(distancesCsvFilepath);
    UNUSED(videoParametersFilepath);
}

void setup_SPR30_9c47736dad95(
    std::string& recordingIdStr,
    Path& videoPath,
    Path& vifPath,
    std::string& cameraName,
    ...
    Path& videoParametersFilepath)
{
    recordingIdStr = "SPR-29_9c47736dad95";

    Path rootDir{R"(D:\Projects\Spirallo\Videos\Marcin\20-03-26-Spirallo-RCX100\Video\Sec)"};
    std::string recordingStem{R"(50-100_770779e0-39c1-4131-9c07-9c47736dad95)"};
    ...
    Path& videoParametersFilepath)
{
    ...
    Path rootDir{R"(D:\Development\Spirallo\_ISSUES\SPR-36_mpeg)"};
    std::string recordingStem{R"(2024-08-06_12-14_0001)"};

    videoPath = rootDir / (recordingStem + ".mpeg");
    vifPath = rootDir / (recordingStem + ".txt");
    projectDistanceUnit = DistanceUnit::Meter;
    cameraName = "Ipek RCX100 HD Serie V";
