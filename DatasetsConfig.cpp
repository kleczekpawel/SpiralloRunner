    ...
    // for (auto const& entry : recordingsCategories)
    {
        if (val.find(recordingId) != val.end())
        {
            if (recordingsRootDirs.find(key) == recordingsRootDirs.end())
            {
                ...
                {
                    std::cout << "[WARN] 'Extra' recordingId not found in recordingsRootDirs."
                              << std::endl;
                }
...
std::unordered_map<RecordingCategory, std::set<RecordingId>> recordingsCategories{
    {RecordingCategory::iPEK,
     {RecordingId::iPEK1,
      RecordingId::iPEK2,
      RecordingId::iPEK2Short,
      RecordingId::iPEK3,
      RecordingId::iPEK4,
      RecordingId::iPEK5,
      RecordingId::iPEK6,
    ...
    {RecordingCategory::Jim,
     {RecordingId::Jim1,
      ...
      RecordingId::Jim14_18in,
      RecordingId::Jim15_24in,
      RecordingId::Jim16_32in,
      RecordingId::Jim17_32in,
    ...
    {RecordingCategory::Talha,
     {
         ...
         RecordingId::Talha3,
         RecordingId::Talha4,
         RecordingId::Talha5_DN400_Ref1,
         RecordingId::Talha6,
         RecordingId::Talha7_RCX100,
         RecordingId::Talha8_RCX100,
    ...
    {RecordingCategory::Philipp,
     {
         RecordingId::Philipp1,  RecordingId::Philipp2,  RecordingId::Philipp3,
         RecordingId::Philipp4,  RecordingId::Philipp5,  RecordingId::Philipp6,
         RecordingId::Philipp7,  RecordingId::Philipp8,  RecordingId::Philipp9,
         RecordingId::Philipp10, RecordingId::Philipp11, RecordingId::Philipp12,
         RecordingId::Philipp13, RecordingId::Philipp14, RecordingId::Philipp15,
         RecordingId::Philipp16, RecordingId::Philipp17, RecordingId::Philipp18,
         RecordingId::Philipp19, RecordingId::Philipp20, RecordingId::Philipp21,
         RecordingId::Philipp22, RecordingId::Philipp23, RecordingId::Philipp24,
         RecordingId::Philipp25, RecordingId::Philipp26, RecordingId::Philipp27,
         RecordingId::Philipp28, RecordingId::Philipp29, RecordingId::Philipp30,
         RecordingId::Philipp31, RecordingId::Philipp32, RecordingId::Philipp33,
         RecordingId::Philipp34, RecordingId::Philipp35, RecordingId::Philipp36,
         RecordingId::Philipp37, RecordingId::Philipp38, RecordingId::Philipp39,
         RecordingId::Philipp40,
     }},
...
std::unordered_map<RecordingId, fs::path> robotDataFiles{
    ...
    {RecordingId::Philipp35, defaultOutputDir / ARCHIVE_DIR / "philipp035_robot.csv"},
    // {RecordingId::Talha5_DN400_Ref1, defaultOutputDir /
    // "spirallo_output_20250109_112806_robot_1.csv"},
    {RecordingId::DobrzanskiMeters, defaultOutputDir / ARCHIVE_DIR / "tomasz_1_scaled.csv"},
    {RecordingId::Dobrzanski3a, defaultOutputDir / ARCHIVE_DIR / "dobrzanski003a_full.csv"},
    {RecordingId::Philipp39, defaultOutputDir / ARCHIVE_DIR / "philipp039_robot.csv"},
    {RecordingId::Philipp38, defaultOutputDir / ARCHIVE_DIR / "philipp38_robot.csv"},
    // {RecordingId::Philipp38, defaultOutputDir / ARCHIVE_DIR /
    // "dummy_T2V8.csv"},
    {RecordingId::Talha9_RCX100, defaultOutputDir / "ToFix" / "Talha9_RCX100_robot.csv"},
